    ...
    <el-card class="clearfix" shadow="never" v-loading="loadData">
      <el-row>
        <el-form :inline="true" :model="formInline" class="search-form" size="small" @submit.native.prevent>
          <el-form-item>
            <el-date-picker v-model="formInline.startTimeAddedStart" :picker-options="startDatePicker_1" type="date" value-format="timestamp" @change="simpleSearchData" placeholder="激活开始时间（起）"></el-date-picker> -
            <el-date-picker v-model="formInline.startTimeAddedEnd" :picker-options="endDatePicker_1" type="date" value-format="timestamp" @change="simpleSearchData" placeholder="激活开始时间（止）"></el-date-picker>
          </el-form-item>
          <el-form-item>
      ...
      <el-row>
        <el-table ref="listTable" :data="list.data" @sort-change="handleSortChange" :max-height="maxTableHeight" border resizable size="mini">
          ...
          <el-table-column prop="generateTime" label="生成时间" sortable="custom" width="160">
        ...
        <div class="searchForm_vip" style="width:100%;overflow: auto">
          <el-form :inline="false" :model="formInline" size="small" label-width="110px" v-loading="loadData">
            <el-form-item label="激活开始时间">
              <el-date-picker v-model="formInline.startTimeAddedStart" :picker-options="startDatePicker_1" type="date" value-format="timestamp" placeholder="激活开始时间（起）"></el-date-picker> -
              <el-date-picker v-model="formInline.startTimeAddedEnd" :picker-options="endDatePicker_1" type="date" value-format="timestamp" placeholder="激活开始时间（止）"></el-date-picker>
            </el-form-item>
            <el-form-item label="激活结束时间">
              <el-date-picker v-model="formInline.endTimeAddedStart" :picker-options="startDatePicker_2" type="date" value-format="timestamp" placeholder="激活结束时间（起）"></el-date-picker> -
              <el-date-picker v-model="formInline.endTimeAddedEnd" :picker-options="endDatePicker_2" type="date" value-format="timestamp" placeholder="激活结束时间（止）"></el-date-picker>
            </el-form-item>
            <el-form-item label="生成时间">
              <el-date-picker v-model="formInline.startGenerateTime" :picker-options="startDatePicker_3" type="date" value-format="timestamp" placeholder="生成时间（起）"></el-date-picker> -
              <el-date-picker v-model="formInline.endGenerateTime" :picker-options="endDatePicker_3" type="date" value-format="timestamp" placeholder="生成时间（止）"></el-date-picker>
            </el-form-item>
            <el-form-item>
