...
const Directive = r => require.ensure([], () => r(require('@/components/forms/directive.vue')), 'chunk3') // 下发指令
const Addbatch = r => require.ensure([], () => r(require('@/components/forms/addbatch.vue')), 'chunk3') // 添加批次
const Addcarbrand = r => require.ensure([], () => r(require('@/components/forms/addcarbrand.vue')), 'chunk3')
const Addcoreapp = r => require.ensure([], () => r(require('@/components/forms/addcoreapp.vue')), 'chunk3') // 核心应用升级
